...
using StoreDashboard.Blazor.Application.Common.Interfaces.MediatorWrapper;
...
using StoreDashboard.Blazor.Infrastructure.Configurations;
using StoreDashboard.Blazor.Infrastructure.Constants.ClaimTypes;
using StoreDashboard.Blazor.Infrastructure.Constants.Database;
using StoreDashboard.Blazor.Infrastructure.Constants.User;
using StoreDashboard.Blazor.Infrastructure.PermissionSet;
using StoreDashboard.Blazor.Infrastructure.Persistence;
using StoreDashboard.Blazor.Infrastructure.Persistence.Interceptors;
using StoreDashboard.Blazor.Infrastructure.Services;
using StoreDashboard.Blazor.Infrastructure.Services.Circuits;
using StoreDashboard.Blazor.Infrastructure.Services.Gemini;
using StoreDashboard.Blazor.Infrastructure.Services.Identity;
using StoreDashboard.Blazor.Infrastructure.Services.MediatorWrapper;
using StoreDashboard.Blazor.Infrastructure.Services.MultiTenant;
using ZiggyCreatures.Caching.Fusion;

namespace StoreDashboard.Blazor.Infrastructure;
...
public static class DependencyInjection
{
    ...
    private const string POSTGRESQL_MIGRATIONS_ASSEMBLY = "StoreDashboard.Blazor.Migrators.PostgreSQL";
    private const string MSSQL_MIGRATIONS_ASSEMBLY = "StoreDashboard.Blazor.Migrators.MSSQL";
    private const string SQLITE_MIGRATIONS_ASSEMBLY = "StoreDashboard.Blazor.Migrators.SqLite";
